...
var View = /** @class */ (function (_super) {
    ...
    View.prototype.triggerExternalDrop = function (singleEventDef, isEvent, el, ev, ui,event) {
       ...
       // this.eventDefs = [];
      //  this.clearView();
        PageMethods.addEvents(singleEventDef.dateProfile.start._d.format('dd/MM/yyyy'), $('#hfDroppedIdGloble').val(), $('#hfDroppedTextGloble').val());
      
     //    $('#calendar').fullCalendar({ events: "CalenderData/JsonResponse.ashx", });
...
var Calendar = /** @class */ (function () {
    ...
    */
    ...
    //Calendar.prototype.eventRender = function (legacyQuery) {

    //    debugger;
    //};

    Calendar.prototype.removeEventsReload = function (legacyQuery) {
